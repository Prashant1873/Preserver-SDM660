...
#if defined (CONFIG_MACH_XIAOMI_NEW_CAMERA) || defined(CONFIG_XIAOMI_CAMERA_MIUI_Q)
...
#ifndef CONFIG_XIAOMI_CAMERA_MIUI_Q	
...
#endif /*CONFIG_XIAOMI_NEW_CAMERA_BLOBS*/	
#endif /*CONFIG_XIAOMI_CAMERA_MIUI_Q*/	
	struct msm_sensor_power_setting_array power_setting_array;
	unsigned char  is_init_params_valid;
	struct msm_sensor_init_params sensor_init_params;
	enum msm_sensor_output_format_t output_format;
	uint8_t bypass_video_node_creation;
#ifdef CONFIG_XIAOMI_CAMERA_MIUI_Q
	struct msm_vendor_id_info_t vendor_id_info;
	struct msm_vcm_id_info_t vcm_id_info;
	struct msm_lens_id_info_t lens_id_info;
#endif /*CONFIG_XIAOMI_CAMERA_MIUI_Q*/	
