...
static unsigned int default_up_delay_lp[] = {1000, 4000};

static unsigned int default_efficient_freq_hp[] = {1113600, 1747200};
static unsigned int default_up_delay_hp[] = {1000, 5000};
